...
public TransferEvaluationResult save(TransferEvaluationResult r) { return repo.save(r); }
public TransferEvaluationResult get(Long id) { return repo.findById(id).orElseThrow(); }
public List<TransferEvaluationResult> getAll() { return repo.findAll(); }
